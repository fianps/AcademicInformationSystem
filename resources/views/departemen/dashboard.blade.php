        ...
        <div class="card board1 fill">
          <div class="card-body">
            <div class="dash-widget-header">
              <div>
                <h3 class="card_widget_header">{{$totalMhs}}</h3>
      ...
      <div class="col-xl-3 col-sm-6 col-12">
        <div class="card board1 fill">
          <div class="card-body">
            <div class="dash-widget-header">
              <div>
                <h3 class="card_widget_header">{{$totalLulus}}</h3>
                <h6 class="text-muted">Students Graduate</h6>
              </div>
              <div class="ml-auto mt-md-3 mt-lg-0">
                <span class="opacity-7 text-muted">
      ...
      <div class="col-xl-3 col-sm-6 col-12">
        <div class="card board1 fill">
          <div class="card-body">
            <div class="dash-widget-header">
              <div>
                <h3 class="card_widget_header">{{$totalProses}}</h3>
                <h6 class="text-muted">Thesis On Progress</h6>
              </div>
              <div class="ml-auto mt-md-3 mt-lg-0">
                <span class="opacity-7 text-muted">
      ...
      <div class="col-xl-3 col-sm-6 col-12">
        <div class="card board1 fill">
          <div class="card-body">
            <div class="dash-widget-header">
              <div>
                <h3 class="card_widget_header">{{$totalPKL}}</h3>
                <h6 class="text-muted">PKL</h6>
              </div>
              <div class="ml-auto mt-md-3 mt-lg-0">
                <span class="opacity-7 text-muted">
